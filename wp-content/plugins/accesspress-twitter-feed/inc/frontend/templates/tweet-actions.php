...
<div class="aptf-tweet-actions-wrapper">
    <a href="https://twitter.com/intent/tweet?in_reply_to=<?php echo $tweet->id_str; ?>" class="aptf-tweet-reply aptf-tweet-action-reply" target="_blank">Reply</a>
    <a href="https://twitter.com/intent/retweet?tweet_id=<?php echo $tweet->id_str; ?>" class="aptf-tweet-retweet aptf-tweet-action-retweet" target="_blank">Retweet</a>
    <a href="https://twitter.com/intent/favorite?tweet_id=<?php echo $tweet->id_str; ?>" class="aptf-tweet-fav aptf-tweet-action-favourite" target="_blank">Favorite</a>
</div>
