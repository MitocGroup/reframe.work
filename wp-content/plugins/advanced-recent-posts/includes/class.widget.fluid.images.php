        ...
        ?>
			...
			<li>
				...
				<div class="lptw-post-thumbnail">
                    <div class="overlay overlay-<?php echo $color_scheme; ?>"><div class="thmbImage" href="<?php the_permalink(); ?>" style="background: transparent url(<?php echo $url; ?>); " alt="<?php get_the_title() ? the_title() : the_ID(); ?>"></div></div>
