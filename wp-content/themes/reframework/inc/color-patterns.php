 ...
 */
function reframework_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'reframework_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.reframework-front-page) .entry-title,
...
.colors-custom .reframework-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.reframework-front-page .panel-content .recent-posts article,
...
.colors-custom.reframework-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'reframework_custom_colors_css', $css, $hue, $saturation );
}
